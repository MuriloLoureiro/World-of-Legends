...
enum ShootType_t : uint8_t {
	...
	CONST_ANI_POKEBALL = 55,
	CONST_ANI_GREATBALL = 56,
	CONST_ANI_ULTRABALL = 57,
	CONST_ANI_SAFFARIBALL = 58,
	CONST_ANI_MASTERBALL = 59,
...
enum SpeakClasses : uint8_t {
	...
	TALKTYPE_POKEMON_SAY = 38,
	TALKTYPE_POKEMON_YELL = 39,
};
...
enum PlayerFlags : uint64_t {
	...
	PlayerFlag_HasInfinitePokemonCapacity = static_cast<uint64_t>(1) << 38,
};
