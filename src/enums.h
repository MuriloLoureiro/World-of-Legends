...
enum CombatType_t : uint16_t {
	...
	COMBAT_ARCANEDAMAGE = 1 << 12,
	COMBAT_INFERNALDAMAGE = 1 << 13,
	COMBAT_PUREDAMAGE = 1 << 14,
	COMBAT_CHAOSDAMAGE = 1 << 15,
	COMBAT_COUNT = 12
};
...
enum ConditionType_t {
	...
	CONDITION_INFERNAL = 1 << 28,
	CONDITION_CHAOS = 1 << 29,
	CONDITION_PURE = 1 << 30,
	CONDITION_ARCANE = 1 << 31,
};
